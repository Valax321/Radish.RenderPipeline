...
namespace Radish.Rendering
{
        ...
        where TPipeline : RenderPipeline
    {
        ...
        public static RadishRenderPipelineSettings<TPipeline> Ensure(bool canCreateNewAsset = true)
        {
            ...
            {
                if (GraphicsSettings.defaultRenderPipeline is RadishRenderPipelineAsset)
                {
                    currentInstance = GraphicsSettings.GetSettingsForRenderPipeline<TPipeline>() as RadishRenderPipelineSettings<TPipeline>;
                }
            }
